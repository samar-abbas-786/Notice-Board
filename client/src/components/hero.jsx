...
const Hero = () => {
  ...
  return (
    <div className="relative pt-10 flex flex-col items-center justify-center h-[100vh] text-white text-center bg-gradient-to-br from-blue-900 via-black to-cyan-900">
